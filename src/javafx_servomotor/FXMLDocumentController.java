...
!> Revisions:
!> (Date) - Author
!> 05/04/2016 - Added time lable to estimate travel time on s-curve window
!>  
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 */
...
import javafx_servomotor.FXMLDocumentController;
import java.net.URL;
...
public class FXMLDocumentController implements Initializable {
      ...
      static private volatile boolean killMe=false;
        ...
        //Piston diameter
        double d_piston=3*25.4/1000;
        //Jet diameter
        double d_jet=2.0/1000;  
...
//===============================================================================================    
    ...
    private void myToggleGroupAct(ActionEvent event) {
        ...
        PistonCurentSpeed=Piston_Max_speed;
        ...
        Label_JetTime.setText("Time to travel = " +numb_form.format(SliderPos/PistonCurentSpeed)+" s");
